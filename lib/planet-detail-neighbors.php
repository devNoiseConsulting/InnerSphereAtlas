...
P.planet_id, P.name AS planet_name, P.x_coord, P.y_coord, P.factory, P.fluff, P.slug, 1 AS jumps
FROM jump_points JP, planet P
WHERE
JP.planet_id=:planet AND
JP.jump_id = P.planet_id)
UNION
(SELECT DISTINCT P.planet_id, P.name AS planet_name, P.x_coord, P.y_coord, P.factory, P.fluff, P.slug, 2 AS jumps
